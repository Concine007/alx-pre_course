#!/usr/bin/python3
"""De fi ne s un it te st s f o r co ns ol e . p y.
...
class TestHBNBCommand_create(unittest.TestCase):
    """Uni ttests fo r tes ting crea te fro m th e HB NB."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Uni ttes ts f or tes ting  sh ow fr om th e HB NB  co mma nd"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Uni tte st s fo r te st in g de st ro y f ro m th e HB NB."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Uni ttes ts f or te sti ng a ll of  th e HB NB"""
